...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2021 at 05:26 AM
...
(12, 17, 1, 'nutritionist@gmail.com', 'regarding password', 'password cannot change', 0),
...
(2, 'driver2', '984536785V', 'B567834', '0773546235', 'driver2@gmail.com', '$2y$10$PJWA18PNEir46mVdS5N43OH56Xflc.QOtWuNAXWNx5i1zYpawk5Qi', 5);
...
INSERT INTO `req_meal_plans` (`request_id`, `user_id`, `name`, `gender`, `age`, `height`, `weight`, `bmi`, `activity_level`, `preference`, `notes`, `status`) VALUES
(14, 44, 'Shifna Shafiq', 'female', 22, 1.75, 42, 13.7143, 'lightly', 'anything', 'need high protein diet', 1),
(18, 48, 'nisal nelaka', 'male', 22, 1.75, 62, 20.2449, 'extremely', 'vegetarian', 'need more nutrition diet', 1),
(19, 46, 'Pramuka Seneviratne', 'male', 22, 1.6, 42, 16.4062, 'very', 'paleo', 'need to loss weight', 0),
...
INSERT INTO `seller` (`res_id`, `resname`, `resaddress`, `sellername`, `phonenumber`, `email`, `password`, `businesstype`, `res_img`) VALUES
(20, ' Laksala ', 'Colombo10', 'Pathmika', '0774563456', 'pathmika@gmail.com', '$2y$10$pvG9RjejfP0KtThO6JEpM.c2nzBJqWp8bg5HRIFPXBcvas3UHDU0y', 'Restaurant', 'assets/restaurant/5.jpg'),
...
(8, 'admin@gmail.com', 'admin', '$2y$10$3KmuW9AsHzXtsIRm3L8dcONycj.AOtkUhmaMi5GAuV.qfRLYZuo8q', 1),
...
(46, 'pramukaseneviratne@gmail.com', 'pramuka', '$2y$10$qwXg9JFz4PCo4DTvHETxl.rAbYD8TZ.4Uqbw5Yjoytd13ATb4TgQy', 3),
...
(46, 'Pramuka Seneviratne', 'pramuka', 'pramukaseneviratne@gmail.com', '$2y$10$qwXg9JFz4PCo4DTvHETxl.rAbYD8TZ.4Uqbw5Yjoytd13ATb4TgQy', '0772020027', 22, 'male', 1.6, 42),
...
--
ALTER TABLE `mealplan`
  MODIFY `mealplan_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `reply`
  MODIFY `reply_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `req_meal_plans`
  MODIFY `request_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
