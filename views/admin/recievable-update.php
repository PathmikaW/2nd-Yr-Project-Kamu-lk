...
<body>
  <div class="admin-dashboard">
      ...
      <div class="user-form form-container">
                ...
                <form class="form" action="../admin/recievable-update?id=<?php echo $id;?>" method="post" style="position:relative; top:120px; left:340px;">
                <h2 style="text-transform: capitalize; color:black;">Update Transaction Details</h2><br>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="date" size="10"
                        value="<?php echo $status;?>" autocomplete="off"  required/><br>
